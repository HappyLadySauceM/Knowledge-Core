...
- **apis**: HTTP idl/http/v1/gateway.thrift GatewayService, health, users/sessions, documents, studio, attachments, admin configuration, Admin 端受控 OpenAPI/AsyncAPI 文档
