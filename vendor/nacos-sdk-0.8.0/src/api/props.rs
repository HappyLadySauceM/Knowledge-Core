...
pub struct ClientProps {
    ...
    env_first: bool,
    /// Whether HTTP and gRPC transports use TLS. Defaults to true for compatibility.
    tls_enabled: bool,
    /// metadata
...
impl ClientProps {
    ...
    pub(crate) fn get_tls_enabled(&self) -> bool {
        self.tls_enabled
    }
...
impl ClientProps {
    ...
    /// Enables or disables TLS for Nacos HTTP and gRPC transports.
